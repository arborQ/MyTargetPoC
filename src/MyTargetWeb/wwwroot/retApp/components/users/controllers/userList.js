...
var UsersList = (function (_super) {
    ...
    UsersList.prototype.showDetails = function () {
        react_router_1.Navigation.transitionTo("userDisplay", { id: this.selectedUser.Id });
    };
    ...
    UsersList.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": "card", "style": { 'maxWidth': ' 800px', 'margin': '0 auto', 'marginTop': '10px' }}, React.createElement("div", {"className": "card-block btn-group"}, React.createElement("button", {"className": "btn btn-success", "onClick": this.showDetails.bind(this), "disabled": !this.isSelected}, "Edit"), React.createElement("button", {"className": "btn btn-default", "disabled": !this.isSelected}, "Display")), React.createElement("div", {"className": "card-block", "ui-view": true}), React.createElement("div", {"className": "card-block"}, React.createElement("table", {"className": "table table-hover"}, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Name"), React.createElement("th", null, "Is Active"))), React.createElement("tbody", null, rows)))));
    };
    return UsersList;
})(React.Component);
