...
$__System.registerDynamic("5", [], true, function($__require, exports, module) {
  ...
  var global = this,
      __define = global.define;
  global.define = undefined;
  exports.viewTemplateUrl = function(module, viewName) {
    return ("/ngApp/modules/" + module + "/views/" + viewName + ".html");
  };
  global.define = __define;
  return module.exports;
});

$__System.registerDynamic("6", ["7", "8", "5", "4"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var angular = $__require('7');
  $__require('8');
  var viewHelper_1 = $__require('5');
  var productList_1 = $__require('4');
  var name = "arbor-products-module";
  var app = angular.module(name, ['ui.router', 'ngResource']);
  app.config(function($stateProvider) {
    $stateProvider.state(name, {
      url: '/products',
      resolve: {userService: function($resource) {
    ...
    $stateProvider.state(name + ".add", {
      url: "/add",
      templateUrl: viewHelper_1.viewTemplateUrl('products', 'productDetails')
    });
    $stateProvider.state(name + ".edit", {
      url: "/edit/:id",
      templateUrl: viewHelper_1.viewTemplateUrl('products', 'productDetails')
    });
  });
...
$__System.registerDynamic("9", [], true, function($__require, exports, module) {
  ...
  var UserList = (function() {
    ...
    Object.defineProperty(UserList.prototype, "selectedUser", {
      get: function() {
        return this.model.filter(function(u) {
          return u.$selected;
        })[0];
      },
      enumerable: true,
...
$__System.registerDynamic("8", ["b"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
$__System.registerDynamic("c", ["7", "8", "9"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
$__System.registerDynamic("d", ["c", "6"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var users_module_1 = $__require('c');
  var products_module_1 = $__require('6');
  Object.defineProperty(exports, "__esModule", {value: true});
  exports.default = [{
    name: users_module_1.default,
    showNavigation: true
  }, {
    name: products_module_1.default,
    showNavigation: true
  }];
  global.define = __define;
  return module.exports;
...
$__System.registerDynamic("7", ["13"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
$__System.registerDynamic("14", ["7"], false, function(__require, __exports, __module) {
...
$__System.registerDynamic("1", ["15", "7", "d", "3", "2"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  $__require('15');
  var angular_1 = $__require('7');
  var pages_1 = $__require('d');
  var config_1 = $__require('3');
  var controller_1 = $__require('2');
  var pageCodes = pages_1.default.map(function(p) {
    return p.name;
  });
  pageCodes.push('ui.router');
  var app = angular_1.module("app", pageCodes);
  app.constant('menuOptions', pages_1.default.filter(function(p) {
    return p.showNavigation;
  }).map(function(p) {
    return p.name;
  }));
...
//# sourceMappingURL=bundle.angular.sfx.js.map